...
public class Room {
    ...
    public String currentRoom; // Current room
    
        
    

    // creates all the hashmap for the rooms, neighbors, items, and encounters
    public Room() {
        rooms = new HashMap<>();
        ...
        currentRoom = "village prison cell"; // make the current room the village prison cell
        createRooms();
    }

    // makes the rooms, neighbors, items, and encounters
    private void createRooms() {
        ...
        rooms.put("supply hut", "**The supply hut is filled with various items that might be useful on your journey.**\n"
                + "**You see food, water, and basic medical supplies.** \n"
                + "\n"
                + "--To the west is the village square.--");
        ...
        rooms.put("forest path", "**You walk along the forest path, surrounded by tall trees and the sounds of wildlife.**\n"
                + "**The path is narrow and winding, and you must stay alert for any dangers.**"
                + "\n"
                + "--To the north is the abandoned cabin, and to the east is a hidden stream.--");
        ...
        rooms.put("hidden stream", "**You find a hidden stream, its clear water flowing gently over smooth stones.**\n"
                + "The area is peaceful, a stark contrast to the chaos of the world beyond.**"
                + "\n"
                + "--To the west is the forest path.--");
        ...
        rooms.put("hidden grove", "**You discover a hidden grove, a small clearing surrounded by tall trees.**\n"
                + "**The grove is filled with wildflowers and the sound of birdsong.**"
                + "\n" 
                + " --To the east is the abandoned cabin.--");
        ...
        roomItems.put("emergency room", Arrays.asList("advanced medical supplies"));
        ...
        rooms.put("military base", "**You arrive at the military base, the final destination in your journey.**\n"
                ...
                + "\n"
                + "--To the north is the THE END or go south maybe there is something there.--");
        neighborNS.put("military base", Arrays.asList("the end", "bad ending"));
        neighborWE.put("military base", Arrays.asList("STOP", "guard post"));
        ...
        // Good ending
        rooms.put("the end", "**YOU BEAT THE GAME!!!!!!!.**\n"
                + "**The fate of the world rests in your hands.**\n\n"
                + "**Thank you for playing!**");
                neighborNS.put("the end", Arrays.asList("STOP", "STOP"));
                neighborWE.put("the end", Arrays.asList("STOP", "STOP"));
        
        //bad ending
        rooms.put("bad ending", "**YOU DIED!!!!!!!.**\n"
                + "**Should of just went north.**\n\n"
                + "**now you gotta do it all over again....**");
                neighborNS.put("bad ending", Arrays.asList("STOP", "STOP"));
                neighborWE.put("bad ending", Arrays.asList("STOP", "STOP"));
    }
